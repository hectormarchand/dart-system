<template>
  <!-- Thanks to https://codepen.io/codeXD/pen/yLLodya -->
  <svg
    viewBox="0 0 455 455"
    version="1.1"
        ...
        <g id="Board" transform="translate(0.500000, 0.500000)">
          ...
          <g id="Inside-Spider" transform="translate(50.000000, 51.000000)" stroke="#D0EDFD">
            ...
            <path
              ...
              fill="#333438"
            ></path>
            <g id="GreenDoubleSpiders" fill="#44b25c">
              <path
            ...
            <g id="GreenTrebleSpiders" transform="translate(64.000000, 66.000000)" fill="#44b25c">
              <path
